...
const getInitials = (name: string) => {
  const cleaned = name.replace(/^(Mr\.|Ms\.)\s+/i, '').trim();
        ...
        <div className={`max-w-3xl mx-auto ${isVisible ? 'animate-fade-up' : 'opacity-0'}`}>
          ...
          >
            ...
            <div className="border-t border-border pt-6 flex flex-col items-center gap-3">
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-full border border-border shadow-md bg-accent/10 text-accent flex items-center justify-center font-bold text-lg">
